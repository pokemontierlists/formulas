...
describe('mean', () => {
  it('Correctly calculates an array of numbers', () => {
    expect(mean([new LibBig(4), new LibBig(7), new LibBig(13)]).toString()).toBe('8');
    expect(mean([new LibBig(5), new LibBig(2)]).toString()).toBe('3.5');
    expect(mean([new LibBig(10), new LibBig(10), new LibBig(10), new LibBig(10)]).toString()).toBe('10');
  });
