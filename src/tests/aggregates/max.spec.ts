...
import { max, maxBy, MaxByNoValuesError } from "../../aggregates/max.js";
  ...
  describe('maxBy', () => {
    ...
    describe('Fallback comparator', () => {
      it('Returns the correct value in a tie', () => {
        ...
        expect(maxBy([a, b, c], value => value.count, (v1, v2) => v1.other - v2.other)).toBe(b);
        expect(maxBy([a, b, c], value => value.count, (v1, v2) => v1.other + v2.other)).toBe(a);
      });
    });
  });
});